    ...
    function scrollToRow(rowIdx) {
        ...
        function renderPagination() {
            ...
            rows.forEach((_, idx) => {
                ...
                button.addEventListener('click', () => scrollToRow(idx));
                pagination.appendChild(button);
            });
        }

        function updatePagination() {
            root.querySelectorAll('.pagination-button').forEach((button, idx) => {
                button.classList.toggle('active', idx === currentRow);
            });
        }
